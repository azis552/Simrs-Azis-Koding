                    ...
                    <div class="card">
                        <div class="card-block">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <h4 class="sub-title">Surat Keterangan Kematian</h4>
                                <a href="{{ route('kasir.ralan.index') }}" class="btn btn-secondary">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <label>Alamat</label>
                                        <input type="text" class="form-control" value="{{ $pasien->alamat_lengkap }}" readonly>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Dokter Pemeriksa</label>
                                        <input type="text" class="form-control" value="{{ $pasien->nm_dokter }}" readonly>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Diagnosa / Penyebab</label>
                                        <input type="text" class="form-control"
                            ...
                            {{-- Form Cetak --}}
                            <form action="{{ route('kasir.ralan.surat.kematian.cetak', $pasien->no_rawat) }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control"
                                                name="tgl_meninggal"
                                                value="{{ old('tgl_meninggal', $pasienMati->tanggal ?? $pasien->tgl_registrasi) }}"
                                                required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="time" step="1" class="form-control"
                                                name="jam_meninggal"
                                                value="{{ old('jam_meninggal', $pasienMati->jam ?? $pasien->jam_reg) }}"
                                                required>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <a href="{{ route('kasir.ralan.index') }}" class="btn btn-secondary ml-2">
