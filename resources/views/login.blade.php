            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="login-card card-block auth-body mr-auto ml-auto">
                        <form  action="{{ route('users.logincheck') }}" method="post" class="md-float-material">
                            <div class="text-center">
                                <img src="{{ asset('') }}/assets/images/azis.png" height="60" width="60"
                                    alt="logo.png">
                                Azis Koding
                            </div>
