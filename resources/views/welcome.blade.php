                                        ...
                                        <ul class="nav nav-tabs md-tabs" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active" data-toggle="tab" href="#home3"
                                                    role="tab"><i class="fa fa-home"></i>Home</a>
                                                <div class="slide"></div>
                                            </li>
                                            <li class="nav-item">
                                            ...
                                            <li class="active-feed">
                                                ...
                                                <div class="row">
                                                    <div class="col-auto text-center">
                                                        <img src="{{ asset('') }}/assets/images/blog/blog-r-1.jpg"
                                                    ...
                                                    <div class="col-auto text-center">
                                                        <img src="{{ asset('') }}/assets/images/blog/blog-r-2.jpg"
                                                            alt="img" class="img-fluid img-100">
                                                    ...
                                                    <div class="col-auto text-center">
                                                        <img src="{{ asset('') }}/assets/images/blog/blog-r-3.jpg"
                                                            alt="img" class="img-fluid img-100">
